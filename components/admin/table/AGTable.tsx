...
const AGTable = ({
    ...
    const localizedCols: ColDef<AGTableModelType>[] = cols.map((col) => ({
        ...
        cellStyle: {textAlign: localeCache.isRtl() ? "right" : "left", direction:localeCache.dir() }, // apply per-cell
        headerClass: localeCache.isRtl()  ? "ag-header-cell-rtl" : "ag-header-cell-ltr",
    }));
